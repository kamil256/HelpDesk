...
namespace HelpDesk.DAL
{
    public class UserRepository// : IRepository<AppUser>
    {
        ...
        public async Task<IEnumerable<AppUser>> Get(IEnumerable<Expression<Func<AppUser, bool>>> filters = null, Func<IQueryable<AppUser>, IOrderedQueryable<AppUser>> orderBy = null, int skip = 0, int take = 0, string includeProperties = "")
        {
